...
public class AuthMapper {
  ...
  public static MentorSignupRequest encodePassword(MentorSignupRequest mentorSignupRequest,
  ...
  public static MenteeSignupRequest encodePassword(MenteeSignupRequest menteeSignupRequest,
      String encodedPassword) {
